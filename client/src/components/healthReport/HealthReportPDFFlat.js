...
const TableRow = ({ index, disease, chance, risk, noBorderBottom }) => (
  <View
    style={[styles.tableRow, noBorderBottom ? { borderBottomWidth: 0 } : {}]}
  >
    <View
      style={[
        styles.tableCell,
        { width: "10%", borderRightColor: "#000", borderRightWidth: 1 },
      ]}
    >
      <Text>{index}</Text>
    </View>
    ...
    <View
      style={[
        styles.tableCell,
        { width: "25%", borderRightColor: "#000", borderRightWidth: 1 },
      ]}
    >
      <Text>{pct(chance)}</Text>
    </View>
    <View style={[styles.tableCell, { width: "25%" }]}>
      <Text style={[styles.tableCellTitle, { color: risk.color }]}>
        {risk.label}
      </Text>
    </View>
  </View>
...
/**
 * A document representing a user's health report in a PDF format.
 *
 * @param {Object} props
 * @param {Object} [props.data] - Health data from health report
 * @param {Object} [props.metaId] - Health report ID
        ...
        <View style={styles.content}>
          ...
          <View style={styles.table}>
            ...
            <View style={styles.tableHeader}>
              ...
              >
                <Text style={styles.tableHeaderCellText}>No.</Text>
              </View>
              <View
                style={[
                  styles.tableHeaderCell,
            ...
            <TableRow
              ...
              chance={data.CVDChance}
              risk={getRisk(data.CVDChance)}
            />
            <TableRow
              index={2}
              disease="Diabetics"
              chance={data.diabetesChance}
              risk={getRisk(data.diabetesChance)}
            />
            <TableRow
              index={3}
              disease="Stroke"
              chance={data.strokeChance}
              risk={getRisk(data.strokeChance)}
              noBorderBottom
            />
          </View>
          ...
          <View style={styles.recommendationSection}>
            ...
            {renderParagraph(
              data.lifestyleRecommendation || data.exerciseRecommendation,
            )}
          </View>
          ...
          <Text style={[styles.disclaimer, { marginTop: 30 }]} break>
            Disclaimer: The information provided by this health prediction
            report is intended for informational purposes only and should not be
            construed as medical advice. Always consult with a qualified
            healthcare professional regarding any questions or concerns you may
            have about your health. Kindly note that the predictions may not be
            completely accurate and may not take into account all relevant
            factors, and results may vary depending on your individual health
            history and circumstances. By using this prediction report, you
            agree that you understand and accept the limitations of the
            information provided.
          </Text>

          <View style={{ marginTop: 20 }}>
            <Text style={styles.privacyText}>
              For our privacy notice, please refer to{" "}
              <Text style={styles.link}>
                https://wellai.app/privacy-notice/
              </Text>
              .
            </Text>
          </View>
