    ...
    >
      <Box sx={{ mb: 6 }}>
        ...
        <Typography variant="h6" color="gray">
          ...
          ante at erat tempus laoreet.
        </Typography>
      </Box>

      <Button href="/merchant-generate-report" size="large" variant="contained">
        Get Started
      </Button>
      ...
      <Box sx={{ display: "flex", flexDirection: "row", mt: 4, gap: 3 }}>
        ...
        {/*</Box>*/}
        <Box sx={{ p: 3, borderRadius: 3, boxShadow: 3 }}>
          <Typography variant="h5">View Report History</Typography>
          <Typography variant="h7" color="gray">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          </Typography>
          <Button
            ...
            size="large"
            variant="contained"
            sx={{ display: "flex", width: "150px", mt: "10px" }}
          >
            View
          </Button>
        </Box>
